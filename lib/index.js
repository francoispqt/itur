 ...
 * @param {generator} g the generator to be ran
 * @param {function|null} thener thener
 * @param {function} resolve wrapped Promise resolver
 * @param {function} reject wrapped Promise rejecter
 */
...
/**
 * Executes a coroutine as long as the condition function returns true
 * @param {function} cond 
 * @param {generator} fn 
 */
 ...
 * Drains the queue
 * @param {generator} fn 
 * @param {Iter} It the Iter instance
 */
const drain = (fn, It) => {
...
class Iter {
    ...
    /**
     * Executes a provided generator as a coroutine once for each array element.
     * @param {array} col 
     * @param {generator} fn 
     */
    ...
    /**
     * Turns a generator into coroutine
     * @param {generator} fn the generator to be ran
     */
    static run(fn) {
        return (...args) => {
            return new Promise((resolve, reject) => {
    ...
    /**
     * Turns an array into an ES2017 iterable applying a coroutine to each element of the array
     * @param {array} col 
     * @param {*} args 
     */
